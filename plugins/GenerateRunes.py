...
from LightPlugin import LightPlugin
import logging
...
def parse_login_data(data):
    ...
    with open(str(wizard['wizard_id']) + "-info.csv", "wb") as wizard_file:
        ...
        LightPlugin.call_plugins('process_csv_row', ('wizard', 'header', (wizard_fields, wizard_headers)))
        ...
        LightPlugin.call_plugins('process_csv_row', ('wizard', 'wizard', (wizard, wizard_data)))
        LightPlugin.call_plugins('process_csv_row', ('wizard', 'footer', wizard_footer))
    ...
    with open(str(wizard['wizard_id']) + "-runes.csv", "wb") as rune_file:
        ...
        LightPlugin.call_plugins('process_csv_row', ('runes', 'header', (rune_fieldnames, runes_header)))
        ...
        for rune in runes:
            ...
            LightPlugin.call_plugins('process_csv_row', ('runes', 'rune', (rune, csv_rune)))
        ...
        with open(str(wizard['wizard_id']) +"-monsters.csv", "wb") as monster_file:
            ...
            LightPlugin.call_plugins('process_csv_row', ('monster', 'header', (monster_fieldnames, monster_header)))
            ...
            for monster in monsters:
                ...
                LightPlugin.call_plugins('process_csv_row', ('monster', 'monster', (monster, csv_monster)))
            ...
            LightPlugin.call_plugins('process_csv_row', ('runes', 'footer', rune_footer))
            LightPlugin.call_plugins('process_csv_row', ('monster', 'footer', monster_footer))
...
class GenerateRunes(LightPlugin):
