...
class ProxyThread(QtCore.QThread):
    ...
    def run(self):
        try:
            ...
            p = LightProxy.HTTP(self.ip, self.port)
            p.run()
...
class MainWindow(QtGui.QMainWindow):
    ...
    def about(self):
        QtGui.QMessageBox.about(self, "About", "LightProxy:Light Proxy Tool\nWritten by KaKaRoTo\nModified by MrStu82\n\nLicensed under LGPLv3 and available at : \n\thttps://github.com/MrStu82/LightProxy\n")

    def openPCAP(self):
        pcap_file = QtGui.QFileDialog.getOpenFileName()
        LightProxy.parse_pcap(pcap_file)
