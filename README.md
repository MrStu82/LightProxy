# Light Monsters & Runes Parser

This tool will parse data captured from the initial Light login data and extract information on the heroes and runes of the user.

This tools purpose is to record the heroes and runes used within a players Light profile.

This tool is based on the SWProxy tool, and the below documentation is from that tool. It will be updated in time.
